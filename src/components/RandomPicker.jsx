...
export const RandomPicker = ({
    ...
    onPick,
    onListen,
    setSelectedAlbum // For clearing selection after remove
}) => {
            ...
            <AnimatePresence mode="wait">
                {selectedAlbum && (
                    <motion.div
                        ...
                        exit={{ opacity: 0, y: -20 }}
                        className="mt-4 bg-gradient-to-b from-zinc-800/50 to-zinc-900/50 rounded-lg p-4 sm:p-6
                    ...
                    >
                        <div className="text-center space-y-3">
                            ...
                            <p className="text-zinc-400 break-words">{selectedAlbum.artist}</p>
                            ...
                            <div className="flex gap-3 mt-4">
                                <motion.button
                                    ...
                                    className="flex-1 py-3 bg-green-500/20 hover:bg-green-500/30 
                                         border border-green-500/30 rounded-lg text-green-400 text-sm sm:text-base"
                                >
                                    Listened
                                </motion.button>
                                <motion.button
                                    ...
                                    className="flex-1 py-3 bg-red-500/20 hover:bg-red-500/30
                                         border border-red-500/30 rounded-lg text-red-400 text-sm sm:text-base"
                                >
                                    Remove
                                </motion.button>
                            </div>
